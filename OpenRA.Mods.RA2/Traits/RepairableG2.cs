...
namespace OpenRA.Mods.RA2.Traits
{
	...
	class RepairableG2Info : ITraitInfo, Requires<IHealthInfo>, Requires<IMoveInfo>
	{
	...
	{
		public readonly RepairableG2Info Info;
		readonly IHealth health;
		readonly IMove movement;
		Rearmable rearmable;

		public Repairable(Actor self, RepairableG2Info info)
		{
			Info = info;
