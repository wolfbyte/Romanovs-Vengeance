...
namespace OpenRA.Mods.RA2.Traits
{
	...
	class ReservableInfo : TraitInfo<ReservableG2> { }

	public class ReservableG2 : ITick, INotifyOwnerChanged, INotifySold, INotifyActorDisposing
	{
		Actor reservedFor;
		AircraftG2 reservedForAircraft;
		...
		public IDisposable Reserve(Actor self, Actor forActor, AircraftG2 forAircraft)
		{
		...
		{
			var res = a.TraitOrDefault<ReservableG2>();
		...
		{
			var res = reservable.TraitOrDefault<ReservableG2>();
