...
namespace OpenRA.Mods.RA2.Traits
{
	...
	public class AttackGarrisonedRVInfo : AttackFollowInfo, IRulesetLoaded, Requires<GarrisonInfo>
	{
		[FieldLoader.Require]
		...
		public override object Create(ActorInitializer init) { return new AttackGarrisonedRV(init.Self, this); }
	...
	public class AttackGarrisonedRV : AttackFollow, INotifyGarrisonerEntered, INotifyGarrisonerExited, IRender
	{
		public readonly new AttackGarrisonedRVInfo Info;
		...
		public AttackGarrisonedRV(Actor self, AttackGarrisonedRVInfo info)
			: base(self, info)
		{
			Info = info;
		...
		{
            // TODO - darky - Refactor - passenger -> garrisoner
			...
			foreach (var a in Armaments)
			{
				...
				if (a.Info.MuzzleSequence != null)
				{
					...
					if (a.Info.MuzzleSplitFacings > 0)
						sequence += OpenRA.Mods.Common.Util.QuantizeFacing(muzzleFacing, a.Info.MuzzleSplitFacings).ToString();
