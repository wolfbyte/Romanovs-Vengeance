...
{
	public class FlyG2 : Activity
	{
		readonly AircraftG2 aircraft;
		...
		public FlyG2(Actor self, Target t, WPos? initialTargetPosition = null, Color? targetLineColor = null)
		{
			aircraft = self.Trait<AircraftG2>();
			target = t;
		...
		public FlyG2(Actor self, Target t, WDist minRange, WDist maxRange,
		...
		public static void FlyToward(Actor self, AircraftG2 aircraft, int desiredFacing, WDist desiredAltitude, int turnSpeedOverride = -1)
		{
