...
{
	public class HeliFlyG2 : Activity
	{
		...
		public HeliFlyG2(Actor self, Target t, WPos? initialTargetPosition = null, Color? targetLineColor = null)
		{
		...
		public HeliFlyG2(Actor self, Target t, WDist minRange, WDist maxRange,
	...
	public class HeliFlyAndLandWhenIdleG2 : HeliFlyG2
	{
		private readonly AircraftG2Info info;

		public HeliFlyAndLandWhenIdleG2(Actor self, Target t, AircraftG2Info info)
			: base(self, t)
		{
			this.info = info;
		}
